namespace Microsoft.BizTalk.ApplicationDeployment.CommandLine
{
    ...
    internal sealed class StartApplicationCommand : Command
    {
        public StartApplicationCommand(NameValueCollection nameValueArgs) : base(nameValueArgs)
        {
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                string formattedString = CommandResources.GetFormattedString(
                    CommandResources.ResourceID.StartApplication, new object[] { applicationName, server, database });
                ...
                application.Start(Microsoft.BizTalk.ExplorerOM.ApplicationStartOption.StartAll);
                explorer.SaveChanges();
                formattedString = CommandResources.GetFormattedString(
                    CommandResources.ResourceID.StartApplicationSuccess, new object[] { applicationName });
                base.WriteLogEntry(LogEntryType.Information, formattedString);
