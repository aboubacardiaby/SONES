namespace Microsoft.BizTalk.ApplicationDeployment.CommandLine
{
    ...
    internal abstract class Command
    {
        ...
        protected void OnLog(object sender, LogEventArgs e)
        {
            if (e != null)
            {
                using (new ConsoleColorChanger(ConsoleColorManager.GetInstance().GetColor((TraceLevel) e.LogEntry.Type)))
                {
        ...
        internal void ShowError(Exception ex)
        {
            ...
            {
//                //Microsoft.BizTalk.ApplicationDeployment.Trace.WriteLine(innerException.ToString(), new object[0]);
        ...
        public virtual List<CommandLineArgumentException> ValidateArgs()
        {
            ...
            if ((values != null) && (values.Length > 1))
            {
                ...
                list.Add(new CommandLineArgumentException(formattedString, string.Empty, TraceLevel.Error));
            }
            return list;
        }
