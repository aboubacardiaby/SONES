namespace Microsoft.BizTalk.ApplicationDeployment.CommandLine
{
    ...
    internal sealed class FullStopApplicationCommand : Command
    {
        public FullStopApplicationCommand(NameValueCollection nameValueArgs) : base(nameValueArgs)
        {
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                string formattedString = CommandResources.GetFormattedString(CommandResources.ResourceID.FullStopApplication, new object[] { applicationName, server, database });
                ...
                formattedString = CommandResources.GetFormattedString(CommandResources.ResourceID.FullStopApplicationSuccess, new object[] { applicationName });
                base.WriteLogEntry(LogEntryType.Information, formattedString);
